...
--------------------------------
    ...
    * Input coupling: DC 
    * Connector: dedicated pins on IDC connector :ref:`E2 <E2_gen1>` (pins 13, 14, 15, 16) 
...
---------------------------------
    ...
    * Output coupling: DC 
    * Connector: dedicated pins on IDC connector :ref:`E2 <E2_gen1>` (pins 17, 18, 19, 20) V
...
----------------------------------------------
    ...
    * Location: IDC connector :ref:`E1 <E1_gen1>`


Powering Red Pitaya through extension connector
================================================

The Red Pitaya can also be powered through pin 1 of the extension connector :ref:`E2 <E2_gen1>`, but in such a case, external protection must be provided by the user in order to protect the board!

.. figure:: img/schematics/Protection.png

|

Protection circuit between +5 V that is provided over the micro USB power connector and +5 VD that is connected to pin1 of the extension connector :ref:`E2 <E2_gen1>`.
...
The ADC clock can be provided by:
    ...
    * From an external source (through extension connector) - External clock :ref:`E2 <E2_gen1>`. (R25, R26 should be moved to location R23, R24).
...
For all other specifications please refer to the :ref:`Gen 1 common hardware specifications <hw_specs_gen1>`.
