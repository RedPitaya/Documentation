...
According to the ADC specification, the external clock signal level should be LVDS in the range of 1MHz to 125MHz. The operating voltage of the Red Pitaya is 3V3.
