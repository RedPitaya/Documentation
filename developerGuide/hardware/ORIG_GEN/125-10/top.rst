...
.. table::
    ...
    +------------------------------------+------------------------------------+
    | Console connector                  | USB to serial converter required   |
    +------------------------------------+------------------------------------+
...
* `Schematics_STEM_125-10_V1.0.pdf <https://downloads.redpitaya.com/doc/Schematics/Schematics_STEM_125-10_V1.0.pdf>`_.
...
* `3D_STEM_125-10_V1.0.zip <https://downloads.redpitaya.com/doc/3D_models/3D_STEM_125-10_V1.0.zip>`_.
...
For all other specifications please refer to standard :ref:`STEMlab 125-14 specs <top_125_14>` and :ref:`Original Gen common hardware specifications <hw_specs_orig_gen>`.
