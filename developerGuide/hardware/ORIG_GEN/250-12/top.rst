...
.. note::
    ...
    We do not have specific measurements for the STEMlab 250-12 board.
...
For all other specifications please refer to the schematics and the :ref:`Original Gen common hardware specifications <hw_specs_orig_gen>`.
