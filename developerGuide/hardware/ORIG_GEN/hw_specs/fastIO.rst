...
#################################
Fast analog IO (original boards)
#################################
...
.. note::
    ...
    The measurements in this section have been made using the original **STEMlab 125-14**. Most measurements can be extended to other board models, but may vary depending on the board model.
