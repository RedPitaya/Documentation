...
.. note::
    ...
    * **Legacy calibration mode** (versions 1-5): Calibration occurs after the frequency filter. Used in streaming from OS 2.07-43 onwards.
    * **Calibration version 6**: Calibration occurs before the frequency filter in the FPGA. Will be enabled for streaming starting with **OS 3.00** (currently in development).

    This register allows switching between legacy and version 6 calibration modes.
