...
.. tabs::
    ...
    .. group-tab:: 125-14-4ADC
        ...
        |          | | Trigger source                                   |  3:0 | R/W |
        |          | | 1 - trig immediately                             |      |     |
        |          | | 2 - ch C threshold positive edge                 |      |     |
        |          | | 3 - ch D threshold negative edge                 |      |     |
        |          | | 4 - ch D threshold positive edge                 |      |     |
        |          | | 5 - ch D threshold negative edge                 |      |     |
        |          | | 6 - external trigger positive edge - DIO0_P pin  |      |     |
        |          | | 7 - external trigger negative edge               |      |     |
        |          | | 8 - arbitrary wave generator application       \ |      |     |
        |          |       positive edge                                |      |     |
        |          | | 9 - arbitrary wave generator application         |      |     |
        |          |       negative edge                             \  |      |     |
        |          | | 10- ch A threshold positive edge                 |      |     |
        |          | | 11- ch A threshold negative edge                 |      |     |
        |          | | 12- ch B threshold positive edge                 |      |     |
        |          | | 13- ch B threshold negative edge                 |      |     |
        +----------+----------------------------------------------------+------+-----+
        | **0x8**  | **Ch C threshold**                                 |      |     |
        +----------+----------------------------------------------------+------+-----+
        |          | Reserved                                           | 31:14| R   |
