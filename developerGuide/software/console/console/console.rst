...
Red Pitaya. Connect your red pitaya to the micro USB CON port on the board. In your terminal utility fill the serial port name and set the speed to 115200.
