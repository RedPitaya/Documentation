...
.. note::
	...
	Requirement for manipulating leds using api is to first load fpga_0.94.bit fpga bitstream image.
...
and **rp_pinState_t *state**. In our program we control **RP_LED0**. There are 8 leds, that we can control
**RP_LED0 - RP_LED7**.
