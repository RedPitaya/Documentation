...
| |                                   | | Python: ``rp_AcqStartCh(<channel>)``                                       | | (Only STEMlab 125-14 4-Input)                                            |                    |
...
| |                                   | |                                                                            | | Used only in split trigger mode                                          |                    |
| |                                   | | Python: ``rp_AcqStopCh(<channel>)``                                        | | (Only STEMlab 125-14 4-Input)                                            |                    |
| |                                   | |                                                                            | | (All boards from 2.07-48)                                                |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
...
| |                                   | |                                                                            | | (All boards from 2.07-48)                                                |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | ``ACQ:UNLOCK``                    | | C++: ``rp_AcqUnlockTrigger()``                                             | Unlocks trigger capture after a trigger has been detected.                 | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
| |                                   | | Python: ``rp_AcqUnlockTrigger()``                                          |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | ``ACQ:UNLOCK:CH<n>``              | | C++: ``rp_AcqUnlockTriggerCh(rp_channel_t)``                               | | Unlocks trigger capture for specified channel.                           | in dev             |
| |                                   | |                                                                            | | Used only in split trigger mode                                          |                    |
| |                                   | | Python: ``rp_AcqUnlockTriggerCh(<channel>)``                               |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | -                                 | | C++: ``rp_AcqGetUnlockTrigger(bool* state)``                               | Gets the trigger's current blocking state.                                 | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
| |                                   | | Python: ``rp_AcqGetUnlockTrigger()``                                       |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | -                                 | | C++: ``int rp_AcqGetUnlockTriggerCh(rp_channel_t channel, bool* state);``  | Gets the trigger's current blocking state in split mode                    | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
...
| |                                   | |                                                                            | | (Only STEMlab 125-14 4-Input)                                            |                    |
| |                                   | | Python: ``rp_AcqSetSplitTrigger(<enable>)``                                | | (All boards from 2.07-48)                                                |                    |
| |                                   | |                                                                            |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | ``ACQ:SPLIT:TRig?`` > ``<state>`` | | C++: ``rp_AcqGetSplitTrigger(bool* state)``                                | | Returns the split trigger mode status                                    | 2.05-37 and up     |
| |                                   | |                                                                            | | (Only STEMlab 125-14 4-Input)                                            |                    |
| |                                   | | Python: ``rp_AcqGetSplitTrigger()``                                        | | (All boards from 2.07-48)                                                |                    |
| |                                   | |                                                                            |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | -                                 | | C++: ``rp_AcqSetSplitTriggerPass(bool enable)``                            | | Makes it possible to call Ch functions even if split trigger is not      | in dev             |
| |                                   | |                                                                            | | supported in hardware, by forwarding to common functions.                |                    |
| |                                   | | Python: ``rp_AcqSetSplitTriggerPass(<enable>)``                            | |                                                                          |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | -                                 | | C++: ``rp_AcqGetSplitTriggerPass(bool* state)``                            | Returns the state of function forwarding for channel-specific commands.    | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
| |                                   | | Python: ``rp_AcqGetSplitTriggerPass()``                                    |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | ``ACQ:M16BIT <state>``            | | C++: ``rp_AcqSet16BitMode(bool enable)``                                   | | Enables the mode when the FPGA returns data in 16-bit format.            | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
| |                                   | | Python: ``rp_AcqSet16BitMode(<enable>)``                                   |                                                                            |                    |
| |                                   | |                                                                            |                                                                            |                    |
+-------------------------------------+------------------------------------------------------------------------------+----------------------------------------------------------------------------+--------------------+
| | ``ACQ:M16BIT?`` > ``<state>``     | | C++: ``rp_AcqGet16BitMode(bool* state)``                                   | | Returns the 16-bit mode status                                           | in dev             |
| |                                   | |                                                                            |                                                                            |                    |
...
| | ``ACQ:DEC:CH1 4``                                 | | Python: ``rp_AcqSetDecimationCh(<channel>, <decimation>)``                                   | | (Only STEMlab 125-14 4-Input)                                               |                    |
| |                                                   | |                                                                                              | | (All boards from 2.07-48)                                                   |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
...
| | Example:                                          | |                                                                                              | | Used only in split trigger mode                                             |                    |
| | ``ACQ:DEC:CH1?`` > ``1``                          | | Python: ``rp_AcqGetDecimationCh(<channel>)``                                                 | | (Only STEMlab 125-14 4-Input)                                               |                    |
| |                                                   | |                                                                                              | | (All boards from 2.07-48)                                                   |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
...
| | Example:                                          | |                                                                                              | | Used only in split trigger mode                                             |                    |
| | ``ACQ:DEC:Factor:CH1?`` > ``1``                   | | Python: ``rp_AcqGetDecimationFactorCh(<channel>)``                                           | | (Only STEMlab 125-14 4-Input)                                               |                    |
| |                                                   | |                                                                                              | | (All boards from 2.07-48)                                                   |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
...
| |                                                   | |                                                                                              | | (All boards from 2.07-48)                                                   |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:FILTER:BYPASS:CH<n> <bypass>``              | | C++: ``rp_AcqSetBypassFilter(rp_channel_t channel, bool enabled)``                           | | The function enables or disables the filter in the FPGA.                    | 2.07-43 and up     |
| |                                                   | |                                                                                              | |                                                                             |                    |
| |                                                   | | Python: ``rp_AcqSetBypassFilter(<channel>, <enable>)``                                       | |                                                                             |                    |
| |                                                   | |                                                                                              | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:FILTER:BYPASS:CH<n>?`` > ``<bypass>``       | | C++: ``rp_AcqGetBypassFilter(rp_channel_t channel, bool *enabled)``                          | | Gets the current filter bypass from the FPGA                                | 2.07-43 and up     |
| | Example:                                          | |                                                                                              | |                                                                             |                    |
| | ``ACQ:FILTER:BYPASS:CH1?`` > ``ON``               | | Python: ``rp_AcqGetBypassFilter(<channel>)``                                                 | |                                                                             |                    |
| |                                                   | |                                                                                              | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:OFFS <offset>``                     | | C++: ``rp_AcqSetOffset(rp_channel_t channel, float value)``                                  | | Adds a voltage offset when requesting data. Only affects float and double   | in dev             |
| | Example:                                          | |                                                                                              | | data types. Raw data remains unchanged.                                     |                    |
| | ``ACQ:SOUR1:OFFS 0.1``                            | | Python: ``rp_AcqSetOffset(<channel>, <value>)``                                              | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:OFFS?`` > ``<offset>``              | | C++: ``rp_AcqGetOffset(rp_channel_t channel, float* value)``                                 | | Returns the offset value in volts.                                          | in dev             |
| | Example:                                          | |                                                                                              | |                                                                             |                    |
| | ``ACQ:SOUR1:OFFS?`` > ``0.1``                     | | Python: ``rp_AcqGetOffset(<channel>)``                                                       | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
...
| |                                                   | |                                                                                              | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:DATA:BYTE:ORDER <order>``                   | | C++: - (N/A)                                                                                 | | Sets the byte order that the server returns when queried in BIN mode.       | 2.07-43 and up     |
| | Example:                                          | |                                                                                              | | For maximum performance, set the mode to LEND                               |                    |
| | ``ACQ:DATA:BYTE:ORDER LEND``                      | | Python: - (N/A)                                                                              | | Only for remote SCPI control.                                               |                    |
| |                                                   | |                                                                                              | |                                                                             |                    |
+-----------------------------------------------------+------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+--------------------+
| | ``ACQ:DATA:BYTE:ORDER?`` > ``<order>``            | | C++: - (N/A)                                                                                 | | Returns the current byte order setting.                                     | 2.07-43 and up     |
| | Example:                                          | |                                                                                              | | Only for remote SCPI control.                                               |                    |
...
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT:ENABLE <mode>,<enable>``                   | | C++: ``rp_AcqSetIntMask(rp_int_mode_t mode, bool enable)``                         | | Enables or disables interrupt generation for the specified                  | 3.00-57 and up          |
...
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT:ENABLE? <mode>`` > ``<enable>``            | | C++: ``rp_AcqGetIntMask(rp_int_mode_t mode, bool* enable)``                        | | Returns the current interrupt enable/disable status for the                 | 3.00-57 and up          |
...
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT:ENABLE:CH<n> <mode>,<enable>``             | | C++: ``rp_AcqSetIntMaskCh(rp_channel_t channel, rp_int_mode_t mode, bool enable)`` | | Enables or disables interrupt generation for the specified                  | 3.00-57 and up          |
...
| |                                                           | |                                                                                    | |                                                                             |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT:ENABLE:CH<n>? <mode>`` >                   | | C++: ``rp_AcqGetIntMaskCh(rp_channel_t channel, rp_int_mode_t mode,``              | | Returns the current interrupt enable/disable status for the                 | 3.00-57 and up          |
...
| |                                                           | |                                                                                    | |                                                                             |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT<timeout_ms>:STAT?`` > ``<tr_state>``       | | C++: ``rp_AcqIntTriggerRead(int timeout_ms)``                                      | | Waits for a trigger interrupt event on any channel with timeout in ms.      | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    | | Use -1 to disable timeout.                                                  |                         |
| | ``ACQ:TRig:INT1000:STAT?`` > ``OK``                       | | Python: ``rp_AcqIntTriggerRead(<timeout_ms>)``                                     |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT<timeout_ms>:STAT:CH<n>?`` > ``<tr_state>`` | | C++: ``rp_AcqIntTriggerReadCh(rp_channel_t channel, int timeout_ms)``              | | Waits for trigger interrupt on specified channel with timeout in ms.        | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    | | Use -1 to disable timeout.                                                  |                         |
| | ``ACQ:TRig:INT:STAT:CH1?`` > ``OK``                       | | Python: ``rp_AcqIntTriggerReadCh(<channel>, <timeout_ms>)``                        |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| | Example:                                                  | |                                                                                    | | Used only in split trigger mode                                             |                         |
| | ``ACQ:TRig:FILL:CH1?`` > ``1``                            | | Python: ``rp_AcqGetBufferFillStateCh(<channel>)``                                  | | (Only STEMlab 125-14 4-Input)                                               |                         |
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT<timeout_ms>:FILL?`` > ``<tr_state>``       | | C++: ``rp_AcqIntFillRead(int timeout_ms)``                                         | | Waits for a buffer fill interrupt event on any channel with timeout in ms.  | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    | | Use -1 to disable timeout.                                                  |                         |
| | ``ACQ:TRig:INT1000:FILL?`` > ``OK``                       | | Python: ``rp_AcqIntFillRead(<timeout_ms>)``                                        |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:INT<timeout_ms>:FILL:CH<n>?`` > ``<tr_state>`` | | C++: ``rp_AcqIntFillReadCh(rp_channel_t channel, int timeout_ms)``                 | | Waits for buffer fill interrupt on specified channel with timeout in ms.    | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    | | Use -1 to disable timeout.                                                  |                         |
| | ``ACQ:TRig:INT:FILL:CH1?`` > ``OK``                       | | Python: ``rp_AcqIntFillReadCh(<channel>, <timeout_ms>)``                           |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| | Example:                                                  | |                                                                                    | | Used only in split trigger mode                                             |                         |
| | ``ACQ:TRig:DLY:CH1?`` > ``2314``                          | | Python: ``rp_AcqGetTriggerDelayCh(<channel>)``                                     | | (Only STEMlab 125-14 4-Input)                                               |                         |
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| | Example:                                                  | |                                                                                    | | Used only in split trigger mode                                             |                         |
| | ``ACQ:TRig:DLY:NS:CH1?`` > ``128`` ns                     | | Python: ``rp_AcqGetTriggerDelayNsCh(<channel>)``                                   | | (Only STEMlab 125-14 4-Input)                                               |                         |
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:PRE:COUNTER?`` > ``<pre_counter>``             | | C++: ``rp_AcqGetPreTriggerCounter(uint32_t* value)``                               | | Returns the number of valid data points (samples) in the buffer             | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    | | before the trigger position.                                                |                         |
| | ``ACQ:TRig:PRE:COUNTER?`` > ``8192``                      | | Python: ``rp_AcqGetPreTriggerCounter()``                                           | |                                                                             |                         |
| |                                                           | |                                                                                    | |                                                                             |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TRig:PRE:COUNTER:CH<n>?`` > ``<pre_counter>``       | | C++: ``rp_AcqGetPreTriggerCounterCh(rp_channel_t channel, uint32_t* value)``       | | Returns the number of valid data points (samples) in the buffer             | 3.00-57 and up          |
...
| | Example:                                                  | |                                                                                    | | Used only in split trigger mode                                             |                         |
| | ``ACQ:TRig:LEV:CH1 0.125 V``                              | | Python: ``rp_AcqSetTriggerLevel(<channel>, <voltage>)``                            | | (Only STEMlab 125-14 4-Input)                                               |                         |
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
| |                                                           | |                                                                                    | |                                                                             |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| | Example:                                                  | |                                                                                    | | Used only in split trigger mode                                             |                         |
| | ``ACQ:TRig:LEV:CH1?`` > ``0.123`` V                       | | Python: ``rp_AcqGetTriggerLevel(<channel>)``                                       | | (Only STEMlab 125-14 4-Input)                                               |                         |
| |                                                           | |                                                                                    | | (All boards from 2.07-48)                                                   |                         |
| |                                                           | |                                                                                    | |                                                                             |                         |
| |                                                           | |                                                                                    |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| |                                                           | |                                                                                    | |                                                                             |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TS <time_ns>``                                      | | C++: ``rp_AcqSetInitTimestamp(uint64_t value)``                                    | Set initial timestamp value for acquisition (clock cycles).                   | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    |                                                                               |                         |
| | ``ACQ:TS 0``                                              | | Python: ``rp_AcqSetInitTimestamp(<value>)``                                        |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
| | ``ACQ:TS:CH<n>?`` > ``<time_ns>``                         | | C++: ``rp_AcqGetTimestamp(rp_channel_t, uint64_t* time_ns)``                       | Get acquisition timestamp for specified channel in ns.                        | 3.00-57 and up          |
| | Example:                                                  | |                                                                                    |                                                                               |                         |
| | ``ACQ:TS:CH1?`` > ``12345``                               | | Python: ``rp_AcqGetTimestamp(<channel>)``                                          |                                                                               |                         |
+-------------------------------------------------------------+--------------------------------------------------------------------------------------+-------------------------------------------------------------------------------+-------------------------+
...
| | Example:                            | |                                                                                 | | Used only in split trigger mode                        |                    |
| | ``ACQ:TPOS:CH1?`` > ``512``         | | Python: ``rp_AcqGetWritePointerAtTrigCh(<channel>)``                            | | (Only STEMlab 125-14 4-Input)                          |                    |
| |                                     | |                                                                                 | | (All boards from 2.07-48)                              |                    |
| |                                     | |                                                                                 |                                                          |                    |
| |                                     | |                                                                                 |                                                          |                    |
+---------------------------------------+-----------------------------------------------------------------------------------+----------------------------------------------------------+--------------------+
...
| SCPI                                        | API, Jupyter                                                                                                                             | DESCRIPTION                                                                            |  ECOSYSTEM         |
+=============================================+==========================================================================================================================================+========================================================================================+====================+
| | ``ACQ:SOUR<n>:DATA:STArt:End?``           | | C++: ``rp_AcqGetDataPosRaw(rp_channel_t channel, uint32_t start_pos, uint32_t end_pos, int16_t* buffer, uint32_t* buffer_size)``       | | Read samples from ``start_pos`` to ``end_pos``. For API commands, the buffer for     | 1.04-18 - 2.07-48  |
...
| | ``{123,231,-231}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:STArt:End?``           | | C++: ``rp_AcqGetDataRawWithCalib(rp_channel_t channel, uint32_t start_pos, uint32_t end_pos, int16_t* buffer, uint32_t* buffer_size)`` | | Read samples from ``start_pos`` to ``end_pos``. For API commands, the buffer for     | 3.00-57 and up     |
| | ``<start_pos>,<end_pos>``                 | |      ``rp_AcqGetDataPosV(rp_channel_t channel, uint32_t start_pos, uint32_t end_pos, float* buffer, uint32_t* buffer_size)``           | | data storage and its size must also be provided. Use ``rp_createBuffer`` to allocate |                    |
| | Example:                                  | | Python: ``rp_AcqGetDataRawWithCalib(<channel>, <start_pos>, <end_pos>, <buffer>, <buffer_size>)``                                      | | data for Python and *malloc* for C++. API commands have two functions to return data |                    |
| | ``ACQ:SOUR1:DATA:STArt:End? 10,13`` >     | |         ``rp_AcqGetDataPosV(<channel>, <start_pos>, <end_pos>, <buffer>, <buffer_size>)``                                              | | in Volts or RAW.                                                                     |                    |
| | ``{123,231,-231}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:STArt:N?``             | | C++: ``rp_AcqGetDataRaw(rp_channel_t channel,  uint32_t pos, uint32_t* size, int16_t* buffer)``                                        | | Read ``size`` samples from the ``<start_pos>`` onwards.                              | 1.04-18 - 2.07-48  |
...
| | ``{1.2,3.2,-1.2}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:STArt:N?``             | | C++: ``rp_AcqGetDataRawWithCalib(rp_channel_t channel,  uint32_t pos, uint32_t* size, int16_t* buffer)``                               | | Read ``size`` samples from the ``<start_pos>`` onwards.                              | 3.00-57 and up     |
| | ``<start_pos>,<size>``                    | |      ``rp_AcqGetDataV(rp_channel_t channel, uint32_t pos, uint32_t* size, float* buffer)``                                             | |                                                                                      |                    |
| | Example:                                  | | Python: ``rp_AcqGetDataRawWithCalib(<channel>, <pos>, <size>, <buffer>)``                                                              | |                                                                                      |                    |
| | ``ACQ:SOUR1:DATA:STArt:N? 10,3`` >        | |         ``rp_AcqGetDataV(<channel>, <pos>, <size>, <buffer>)``                                                                         | |                                                                                      |                    |
| | ``{1.2,3.2,-1.2}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA?``                     | | C++: ``rp_AcqGetOldestDataRaw(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                                 | | Read the full buffer.                                                                | 1.04-18 - 2.07-48  |
...
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA?``                     | | C++: ``rp_AcqGetOldestDataRawWithCalib(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                        | | Read the full buffer.                                                                | 3.00-57 and up     |
| | Example:                                  | |      ``rp_AcqGetOldestDataV(rp_channel_t channel, uint32_t* size, float* buffer)``                                                     | | Starting from the oldest sample in the buffer (first sample after trigger delay).    |                    |
| | ``ACQ:SOUR2:DATA?`` >                     | | Python: ``rp_AcqGetOldestDataRawWithCalib(<channel>, <size>, <buffer>)``                                                               | | If the trigger delay is set to zero, it will read the full buffer size starting      |                    |
| | ``{1.2,3.2,...,-1.2}``                    | |         ``rp_AcqGetOldestDataV(<channel>, <size>, <buffer>)``                                                                          | | from the trigger.                                                                    |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetOldestDataRawWithCalibNP(channel, np_buffer)`` (Numpy buffer ``dtype=np.int16``)                                    | | Copies the oldest captured buffer data into the passed NumPy buffer.                 | 3.00-57 and up     |
| |                                           | |                                                                                                                                        | | The length of the copied data matches the ``np_buffer`` length.                      |                    |
| |                                           | |                                                                                                                                        | | Numpy buffer must have the specified ``dtype`` format.                               |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:Old:N? <size>``        | | C++: ``rp_AcqGetOldestDataRaw(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                                 | | Read the oldest ``<size>`` samples in the buffer.                                    | 1.04-18 - 2.07-48  |
...
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:Old:N? <size>``        | | C++: ``rp_AcqGetOldestDataRawWithCalib(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                        | | Read the oldest ``<size>`` samples in the buffer.                                    | 3.00-57 and up     |
| | Example:                                  | |      ``rp_AcqGetOldestDataV(rp_channel_t channel, uint32_t* size, float* buffer)``                                                     | |                                                                                      |                    |
| | ``ACQ:SOUR2:DATA:Old:N? 3`` >             | | Python: ``rp_AcqGetOldestDataRawWithCalib(<channel>, <size>, <buffer>)``                                                               | |                                                                                      |                    |
| | ``{1.2,3.2,-1.2}``                        | |         ``rp_AcqGetOldestDataV(<channel>, <size>, <buffer>)``                                                                          | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:LATest:N? <size>``     | | C++: ``rp_AcqGetLatestDataRaw(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                                 | | Read the latest ``<size>`` samples in the buffer.                                    | 1.04-18 - 2.07-48  |
...
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:LATest:N? <size>``     | | C++: ``rp_AcqGetLatestDataRawWithCalib(rp_channel_t channel, uint32_t* size, int16_t* buffer)``                                        | | Read the latest ``<size>`` samples in the buffer.                                    | 3.00-57 and up     |
| | Example:                                  | |      ``rp_AcqGetLatestDataV(rp_channel_t channel, uint32_t* size, float* buffer)``                                                     | |                                                                                      |                    |
| | ``ACQ:SOUR1:DATA:LATest:N? 3`` >          | | Python: ``rp_AcqGetLatestDataRawWithCalib(<channel>, <size>, <buffer>)``                                                               | |                                                                                      |                    |
| | ``{1.2,3.2,-1.2}``                        | |         ``rp_AcqGetLatestDataV(<channel>, <size>, <buffer>)``                                                                          | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetLatestDataRawWithCalibNP(channel, np_buffer)`` (Numpy buffer ``dtype=np.int16``)                                    | | Copies the latest captured buffer data into the passed NumPy buffer.                 | 3.00-57 and up     |
| |                                           | |                                                                                                                                        | | The length of the copied data matches the ``np_buffer`` length.                      |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:TRig? <size>,<t_pos>`` | | C++: ``rp_AcqGetDataRaw(rp_channel_t channel,  uint32_t pos, uint32_t* size, int16_t* buffer)``                                        | | Read ``<size>`` samples relative to the trigger, depending on the setting.           | 2.05-37 - 2.07-48  |
...
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:TRig? <size>,<t_pos>`` | | C++: ``rp_AcqGetDataRawWithCalib(rp_channel_t channel,  uint32_t pos, uint32_t* size, int16_t* buffer)``                               | | Read ``<size>`` samples relative to the trigger, depending on the setting.           | 3.00-57 and up     |
| | Example:                                  | |      ``rp_AcqGetDataV(rp_channel_t channel, uint32_t pos, uint32_t* size, float* buffer)``                                             | | ``PRE_TRIG``, ``POST_TRIG`` trigger configuration returns ``size`` data samples.     |                    |
| | ``ACQ:SOUR1:DATA:TRig? 3,POST_TRIG`` >    | | Python: ``rp_AcqGetDataRawWithCalib(<channel>, <pos>, <size>, <buffer>)``                                                              | | ``PRE_POST_TRIG`` returns ``size`` * 2 + 1 data samples, including the triggering    |                    |
| | ``{1.2,3.2,-1.2}``                        | |         ``rp_AcqGetDataV(<channel>, <pos>, <size>, <buffer>)``                                                                         | | moment                                                                               |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetDataRawNP(channel, pos, np_buffer)`` (Numpy buffer ``dtype=np.int16``)                                              | | Copies the captured buffer data into the passed NumPy buffer from ``pos``            | 2.05-37 and up     |
| |                                           | |         ``rp_AcqGetDataVNP(channel, pos, np_buffer)`` (Numpy buffer ``dtype=np.float32``)                                              | | onwards. The length of the copied data matches the ``np_buffer`` length.             |                    |
