...
| | ``{123,231,-231}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetDataPosRawNP(channel, start_pos, end_pos, np_buffer)``                                                              | | Copies the captured buffer data from ``start_pos`` to ``end_pos`` into the passed    | in dev             |
| |                                           | |         ``rp_AcqGetDataPosVNP(channel, start_pos, end_pos, np_buffer)``                                                                | | NumPy buffer. The length of the copied data must match the ``np_buffer`` length.     |                    |
...
| |                                           | | Python: ``rp_AcqGetDataRawWithCalib(<channel>, <pos>, <size>, <buffer>)``                                                              | | For Python the NP method is faster.                                                  |                    |
| |                                           | |         ``rp_AcqGetDataRawWithCalibNP(channel, pos, np_buffer)``                                                                       | |                                                                                      |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| | ``{1.2,3.2,-1.2}``                        | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetDataRawNP(channel, pos, np_buffer)``                                                                                | | Copies the captured buffer data into the passed NumPy buffer from ``pos``            | in dev             |
| |                                           | |         ``rp_AcqGetDataVNP(channel, pos, np_buffer)``                                                                                  | | onwards. The length of the copied data matches the ``np_buffer`` length.             |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetOldestDataRawNP(channel, np_buffer)``                                                                               | | Copies the oldest captured buffer data into the passed NumPy buffer.                 | in dev             |
| |                                           | |         ``rp_AcqGetOldestDataVNP(channel, np_buffer)``                                                                                 | | The length of the copied data matches the ``np_buffer`` length.                      |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetLatestDataRawNP(channel, np_buffer)``                                                                               | | Copies the latest captured buffer data into the passed NumPy buffer.                 | in dev             |
| |                                           | |         ``rp_AcqGetLatestDataVNP(channel, np_buffer)``                                                                                 | | The length of the copied data matches the ``np_buffer`` length.                      |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ``ACQ:SOUR<n>:DATA:TRig? <size>,<t_pos>`` | | C: ``rp_AcqGetDataRaw(rp_channel_t channel,  uint32_t pos, uint32_t* size, int16_t* buffer)``                                          | | Read ``<size>`` relative to the trigger, depending on the setting.                   | in dev             |
...
| | ``ACQ:SOUR1:DATA:TRig? 3,POST_TRIG`` >    | | Python: ``rp_AcqGetDataRaw(<channel>, <pos>, <size>, <buffer>)``                                                                       | | PRE_POST_TRIG returns data in size * 2 + 1.                                          |                    |
| | ``{1.2,3.2,-1.2}``                        | |         ``rp_AcqGetDataV(<channel>, <pos>, <size>, <buffer>)``                                                                         | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
| | ''                                        | | Python: ``rp_AcqGetDataRawNP(channel, pos, np_buffer)``                                                                                | | Copies the captured buffer data into the passed NumPy buffer from ``pos``            | in dev             |
| |                                           | |         ``rp_AcqGetDataRawNP(channel, pos, np_buffer)``                                                                                | | onwards. The length of the copied data matches the ``np_buffer`` length.             |                    |
| |                                           | |                                                                                                                                        | | Faster than the Python functions above.                                              |                    |
| |                                           | |                                                                                                                                        | |                                                                                      |                    |
+---------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------+--------------------+
...
+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+--------------------+
| | ''                                               | | Python: ``rp_AcqAxiGetDataVNP(channel, pos, np_buffer)``                                                                 | | Copies the captured DMA buffer data into the passed NumPy buffer from ``pos`` | in dev             |
| |                                                  | |         ``rp_AcqAxiGetDataRawNP(channel, pos, np_buffer)``                                                               | | onwards. The length of the copied data matches the ``np_buffer`` length.      |                    |
| |                                                  | |                                                                                                                          | | Faster than the Python functions above.                                       |                    |
| |                                                  | |                                                                                                                          | |                                                                               |                    |
| |                                                  | |                                                                                                                          | |                                                                               |                    |
+----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------+--------------------+
