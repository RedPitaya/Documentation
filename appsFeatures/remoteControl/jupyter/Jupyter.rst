...
* The ability to easily include mathematical notation within markdown cells using LaTeX, rendered natively by |MathJax|.
...
* :github:`Red Pitaya JupyterLab welcome page <RedPitaya/jupyter/blob/master/welcome.ipynb>`.
