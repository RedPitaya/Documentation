...
All Red Pitaya applications are web-based and don't require the installation of any native software. Users can access them via a browser using their smartphone, tablet or a PC running any popular operating system (macOS, Linux, Windows, Android, and iOS). All official applications are accessible through the :ref:`main web interface <ConnectSTEMlab>`.
