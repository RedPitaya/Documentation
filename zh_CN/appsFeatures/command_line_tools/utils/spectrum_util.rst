...
Red Pitaya 频谱分析仪工具是一个命令行工具，用于测量输入信号的频谱。该工具可用于设置最小和最大频率、迭代次数及窗函数，也可用于启用或禁用平均，并以 CSV 格式输出数值。
频谱工具

.. tabs::

    .. group-tab:: OS 版本 2.00 或更高版本
...
Red Pitaya GitHub 仓库包含 :rp-github:`频谱工具的源代码 <RedPitaya/tree/master/tools/spectrum>`。
