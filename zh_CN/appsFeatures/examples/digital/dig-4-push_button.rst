...
本示例演示如何控制 Red Pitaya 板载 LED，并读取扩展连接器 GPIO 的状态。
按下按钮时，LED 将亮起。
...
STEMlab 125-14 和 STEMlab 125-10 的接线示例：
...
- `下载示例 <https://downloads.redpitaya.com/downloads/Clients/labview/Push%20button%20and%20turn%20on%20LED.vi>`_
