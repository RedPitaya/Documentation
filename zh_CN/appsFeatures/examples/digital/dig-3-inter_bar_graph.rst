...
本示例演示如何通过控制 Red Pitaya 板载 LED 制作条形图。
亮起的 LED 数量对应于变量 p 的值，该值可通过 MATLAB® 滑块设置。
...
- `下载示例 <https://downloads.redpitaya.com/downloads/Clients/labview/Interactive%20LED%20bar%20graph.vi>`_
