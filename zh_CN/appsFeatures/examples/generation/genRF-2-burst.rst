...
本示例展示如何生成预定义波形（如正弦波、三角波、方波、上升斜坡、下降斜坡或 PWM）的信号脉冲。生成的信号可用示波器观察。
...
- `下载示例 <https://downloads.redpitaya.com/downloads/Clients/labview/Generate%20signal%20pulses.vi>`_
