...
.. note::
    ...
    For basic installation instructions, see the :ref:`Prepare SD card guide <prepareSD>`.
...
.. note::
    ...
    Generally, the newer the ecosystem, the larger the FAT partition size.
...
.. |this GitHub solution| replace:: :rp-github:`this GitHub solution <RedPitaya/issues/250>`

.. |SUPPORT TEAM| replace:: :rp-web:`support team <contact-us>`
